...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if(rs.next()){
                    ...
                    // Now look up the student name using the studentid from the book record
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(txtbookid.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Please enter Book ID and Search it first");
            ...
            pst=c.prepareStatement("UPDATE `library`.`book` SET `status` = 'NotIssued', `issue` = '', `due` = '', `studentid` = '' WHERE (`id` = ?)");
            pst.setString(1, txtbookid.getText());
            pst.executeUpdate();
