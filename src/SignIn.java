...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1450, 0, 50, -1));
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try {
            ...
            if (c != null) {
                ...
                JOptionPane.showMessageDialog(this, "Database connection failed. You can use 'admin'/'admin' to bypass.");
            }
        } catch (SQLException ex) {
            Logger.getLogger(SignIn.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "Database error. You can use 'admin' / 'admin' to bypass.");
        } finally {
